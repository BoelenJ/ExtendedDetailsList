...
export const enum ColumnsColumns {
    ...
    // Button additions
    ColButtonCaption = 'ColButtonCaption',
    ColButtonStyle = 'ColButtonStyle',
    ColButtonPadding = 'ColButtonPadding',
    ColButtonHeight = 'ColButtonHeight',
    ColButtonIcon = 'ColButtonIcon',
    ColButtonColumn = 'ColButtonColumn',
    ColButtonColumnValue = 'ColButtonColumnValue',
    ColButtonComparison = 'ColButtonComparison'
}
